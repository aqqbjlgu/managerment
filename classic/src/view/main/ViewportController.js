Ext.define('Admin.view.main.ViewportController', {
    ...
    setCurrentView: function(hashTag,statusCode,msg) {
        ...
        if (!existingItem) {
            if(view){
                ...
                newView = Ext.create('Admin.view.' + (hashTag || 'pages.Error404Window'), {
                    hideMode: 'offsets',
                    statusCode: statusCode,
                    msg: msg
                });
                // newView = Ext.create('Admin.view.pages.Error500Panel', {
                //     hideMode: 'offsets',
                //     statusCode: statusCode,
                //     msg: msg
                // });
